...
api.register({
    ...
    likeordislike: async (c, req, res, person) => likeordislike(c, req, res, person, bot),
...
async function likeordislike(c: Context, req: Request, res: Response, person: Person, bot: TelegramBot) {
